...
录：通用书源可在复制到的最后目录页链接后加“?录”，从而自动生成所有目录分页。如“https:/✘/m.zuizaoxiaoshuo.com/ml/33280_13/?录”。全网搜书书源则需在简介中直接指定复制到的最后目录页链接为目录链接并添加指令“录”，也能自动生成所有目录分页。即：{[https:/✘/m.zuizaoxiaoshuo.com/ml/33280_13]录}。
