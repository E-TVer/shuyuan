...
注②：仅谷歌搜书 关键字前加“#”可将域名设置为谷歌原网， 如“#斗破苍穹#天蚕土豆$www.qidian.com”(注：本源默认使用谷歌镜像，谷歌原网需挂VPN才能用)
```
...
动态：关键字前加“$”，`设置本次搜到的所有书籍`正文都动态加载，既设置转化又设置动态时前缀为“@$”

图文：关键字前加“|”，`设置本次搜到的所有书籍`正文只查询文字，不查询图片。或关键字前加“_”，`设置本次搜到的所有书籍`正文只查询图片，不查询文字。
这两个前缀只能设置一个，都不设置时默认图文都查询。
既设置转化又设置动态还设置图文时前缀为“@$|”或“@$_”


〖注〗若谷歌搜书设置域名为谷歌原网后，也采用通过添加前缀的方式控制书源，则“#”必须在最前面，即“#@$|”或“#@$_”。
```
![加前缀设置全部书籍调试图](https://images.gitee.com/uploads/images/2020/1213/210236_d207db44_8324729.jpeg "Screenshot_2020-12-13-21-01-46-615_io.legado.app.release.jpg")
 :fa-film: [修改简介控制书源执行效果示范视频](https://m.weibo.cn/6893627530/4581333811072138)
```
───────简介设置单本────────

说明：将特定字段插入简介保存后，点刷新可实现目录跳转、正文动态加载、目录逆向排序、目录链接指定等多种功能。

局限：修改简介再点刷新只会控制当前书籍执行指定功能，想控制所有书籍执行指定功能，请采用上面`前缀设置全部`的方式在关键字前加相应前缀并重新搜索
...
含义：在“www.qidian.com”中搜名称含“我的”的玄幻小说，并动态加载所有搜到的书籍章节链接，且设置搜到的书籍正文都只查询文字
```
<br><br/>
# 同名书籍换源
...
# 书源相关链接
<br><br/>
酷安大佬失效精品书源修复合集(2020年11月21日及之前分享的书源，修复25个书源)：[https://gitee.com/no-mystery/bushixuanqi-quanwangsoushu/raw/master/%E5%A4%A7%E4%BD%AC%E5%A4%B1%E6%95%88%E4%B9%A6%E6%BA%90%E4%BF%AE%E5%A4%8D%E5%90%88%E9%9B%86.json](https://gitee.com/no-mystery/bushixuanqi-quanwangsoushu/raw/master/%E5%A4%A7%E4%BD%AC%E5%A4%B1%E6%95%88%E4%B9%A6%E6%BA%90%E4%BF%AE%E5%A4%8D%E5%90%88%E9%9B%86.json)
```
新增书虫中文网(破解起点防盗的正文干净书源)
①修复目录展开次数不够导致章节不完整的问题，本源将连续多次展开目录直到全部展开为止。 
②正文用webjs解密 
③优化其它所有规则
```
网络导入->起点中文：[https://gitee.com/no-mystery/bushixuanqi-quanwangsoushu/raw/master/%E8%B5%B7%E7%82%B9%E4%B8%AD%E6%96%87(%E9%80%9F%E5%BA%A6%E6%9C%80%E5%BF%AB%E3%80%81%E5%8F%91%E7%8E%B0%E6%9C%80%E5%85%A8).json](https://gitee.com/no-mystery/bushixuanqi-quanwangsoushu/raw/master/%E8%B5%B7%E7%82%B9%E4%B8%AD%E6%96%87(%E9%80%9F%E5%BA%A6%E6%9C%80%E5%BF%AB%E3%80%81%E5%8F%91%E7%8E%B0%E6%9C%80%E5%85%A8).json)
<br><br/>
网络导入->当书网：[https://gitee.com/no-mystery/bushixuanqi-quanwangsoushu/raw/master/%E5%BD%93%E4%B9%A6%E7%BD%91(%E7%B2%BE%E6%A0%A1%E5%B0%8F%E8%AF%B4%E3%80%81%E5%9C%A8%E7%BA%BF%E9%98%85%E8%AF%BB).json](https://gitee.com/no-mystery/bushixuanqi-quanwangsoushu/raw/master/%E5%BD%93%E4%B9%A6%E7%BD%91(%E7%B2%BE%E6%A0%A1%E5%B0%8F%E8%AF%B4%E3%80%81%E5%9C%A8%E7%BA%BF%E9%98%85%E8%AF%BB).json)
<br><br/>
网络导入->源仓库订阅：[https://gitee.com/no-mystery/bushixuanqi-quanwangsoushu/raw/master/%E6%96%B0%E7%89%88%E6%BA%90%E4%BB%93%E5%BA%93%E8%AE%A2%E9%98%85.json](https://gitee.com/no-mystery/bushixuanqi-quanwangsoushu/raw/master/%E6%96%B0%E7%89%88%E6%BA%90%E4%BB%93%E5%BA%93%E8%AE%A2%E9%98%85.json)
<br><br/>
<br><br/>
...
2. 采用多种搜索方式(`书名#作者$网站`、`书名$网站`、`书名#作者`、`书名`、`#作者(仅夸克支持)`)，具体用法见书源编辑界面首页的“源注释”和[用法展示视频](https://m.weibo.cn/6893627530/4581415641416010)。
...
4. 书名采用关键字切割法，先获得最初级的书名，然后根据各种条件以及搜索页及详情页获取到作者名，进一步识别删除那种书名跟着的作者名或其它无关内容

5. 分类、作者、最新章节规则采用最近文本识别法，用正则表达式进行内容抓取，先定位关键字，再查找是否仅跟冒号或处于标签末尾，然后排除一些常见错误定位，然后识别最近的下个文本

6. 目录链接、章节链接采用“链接构造正则->正则识别链接”这种正则关联上下级链接的思想根据上级链接精确识别下级链接，具体为：根据详情页链接构造出专门识别目录链接的正则表达式去识别目录链接，再根据目录链接构造出专门识别章节链接的正则表达式去识别章节链接，识别能力、识别速度、识别精确度远超堆砌规则的穷举法。

7. 正文规则：采用无用标签移除思想，使用各种判定规则找出所有不可能存在正文内容的标签并全部移除，从而避免获取到与正文无关的文字。
然后剔除链接及其环绕文字，以及网站插入的带有负数编号的宣传文本，再对正文中的`章节名、书名、页尾、未缩进文本(仅在正文存在缩进段落时对未缩进段落进行标记)`施加不同标记。

8. 替换规则：结合正文添加的`章节名、书名、页尾、未缩进文本`四大标记的相互位置以及标记环绕文本，能快速安全的剔除绝大部分网站宣传文本，而且能根据网站强行切断点识别方法判断出这种网站强行切断段落的位置，并绕开不删被网站强行切断到下一页的未缩进正文重新将网站强行切断的内容合并。
<br><br/>
此外：对英文及拼音字符串、数字、图片标签、非中英文字符进行标记，然后结合上下文判断出疑似广告的字符串并施加`特殊标记`，然后再结合上下文其它条件谨慎判断标记成广告的字符串是真广告还是小说内容
9. 书中净化规则特意避开了img标签，净化的同时不会破坏图片显示，所以不仅可以搜书，还可以搜漫画。

10. 单页文章自动构造目录：也就是说，当某个文章中不存在目录时，自动为将构造目录，从而可以浏览没有目录的单页网页，此点可用来看新闻，浏览网页
<br><br/>
<br><br/>
# 更新日志
```
